...
export var StudentRegistration_URL = STUDENTURL_7007 + 'atktoutsideregistration'; //new
export var GetOTP = STUDENTURL_7007 + 'GetOTP';
export var GetOTP_v1_url = STUDENTURL + 'GetOTPv1';
export var studentsforgotmobile = STUDENTURL_7007 + 'studentsforgotmobile'; //new forgotpasword resendotp
export var ValidateOTP = STUDENTURL_7007 + 'ValidateOTP';
